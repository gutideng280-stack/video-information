...
BRANCH = 'main'
COMMIT_MESSAGE = 'Upload video information tool v2.0.0'
...
files_to_upload = [
    ...
    ('js/app.js', 'js/app.js'),
    ('js/components/DataTable.js', 'js/components/DataTable.js'),
    ('js/components/LinkInput.js', 'js/components/LinkInput.js'),
    ('js/components/QueryButton.js', 'js/components/QueryButton.js'),
    ('js/services/bilibili.js', 'js/services/bilibili.js'),
    ('js/services/twitter.js', 'js/services/twitter.js'),
    ('js/services/youtube.js', 'js/services/youtube.js'),
    ('js/utils/linkParser.js', 'js/utils/linkParser.js')
]
